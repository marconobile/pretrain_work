...
def periodic_table_group(atom: Chem.rdchem.Atom) -> int: return PGROUP_IDS[atom.GetSymbol()]
def periodic_table_period(atom: Chem.rdchem.Atom) -> int: return PPERIOD_IDS[atom.GetSymbol()]
